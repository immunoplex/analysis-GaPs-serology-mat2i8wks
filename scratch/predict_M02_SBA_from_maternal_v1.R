# ---
# title:    "Predicting Infant M02 SBA from Maternal and Cord IgG"
...
#
# OUTCOME:  WHOLE_SBA at M02 (infant, before first vaccination)
...
outcome_feature <- "WHOLE_SBA"       # WHOLE_PTNA | WHOLE_SBA | WHOLE_WT_IgG
outcome_label   <- "SBA"             # used in cat() and plot titles
